...
In order to define your own custom data provider for an index, you have to create a service that implements `ProviderInterface` and specify it in the `providerClass` attribute of your document entity.
